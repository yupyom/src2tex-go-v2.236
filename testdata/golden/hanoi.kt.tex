...
\fancyfoot[R]{\rm input{\tt /}hanoi.kt\qquad page \thepage}
...
\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }for{\tt\mc \ }(j{\tt\mc \ }in{\tt\mc \ }0{\tt\mc \ }until{\tt\mc \ }ARRAY){\tt\mc \ }{\tt\char'173}
...
\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }for{\tt\mc \ }(j{\tt\mc \ }in{\tt\mc \ }0{\tt\mc \ }until{\tt\mc \ }ARRAY){\tt\mc \ }{\tt\char'173}
...
\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }moveDiscs(ARRAY,{\tt\mc \ }0,{\tt\mc \ }1,{\tt\mc \ }2){\tt\mc \ \ \ \ \ \ \ \ }{\tt\mc \ \ \ \ \ \ \ \ }\rm\mc {\tt /}{\tt *}\  \ {\tt ARRAY} 枚の disc を
