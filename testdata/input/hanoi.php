...
/* {\hrulefill\ hanoi.php \ \hrulefill} */

$ARRAY = 8;                             /* {\ disc の数 \hfill} */

$disc = array_fill(0, 3, array_fill(0, $ARRAY, 0));
...
function moveOneDisc($i, $j) {          /* {\ 1枚の disc を pole $i$ からpole $j$ に移動する \hfill} */
    global $disc, $ptr;
    $ptr[$i]--;
...
function moveDiscs($n, $i, $j, $k) {    /* {\ \underline{\textsf{上から $n$ 枚目までの disc}}を、pole $i$ から pole $j$ に\hfill} */
