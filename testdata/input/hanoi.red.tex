...
\fancyfoot[R]{\rm hanoi.red\qquad page \thepage}
...
\noindent
\mbox{}\rm\mc {\tt\%} \ \centerline{\bf Towers of Hanoi (Reduce)}
\tt\mc 
...
\noindent
\mbox{}\rm\mc {\tt\%} \hrulefill\ hanoi.red \ \hrulefill
\tt\mc 
...
\noindent
\mbox{}array{\tt\_}size{\tt\mc \ }:={\tt\mc \ }8;{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ disc の数 \hfill
\tt\mc 
...
\noindent
\mbox{}array{\tt\mc \ }disc(2,{\tt\mc \ }7);{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ disc に関するデータの置き場所\hfill
\tt\mc 
...
\noindent
\mbox{}\textbf{procedure}{\tt\mc \ }init{\tt\_}array();{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ disc に関するデータの初期化\hfill
\tt\mc 
...
\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\textbf{for}{\tt\mc \ }j{\tt\mc \ }:={\tt\mc \ }0:array{\tt\_}size{\tt -}1{\tt\mc \ }\textbf{do}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt <}{\tt <}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }disc(0,{\tt\mc \ }j){\tt\mc \ }:={\tt\mc \ }array{\tt\_}size{\tt\mc \ }{\tt -}{\tt\mc \ }j;

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }disc(1,{\tt\mc \ }j){\tt\mc \ }:={\tt\mc \ }0;
...
\noindent
\mbox{}counter{\tt\mc \ }:={\tt\mc \ }0;{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ 移動回数カウンタ \hfill
\tt\mc 
...
\noindent
\mbox{}\textbf{procedure}{\tt\mc \ }print{\tt\_}result();{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ 結果の表示 \hfill
\tt\mc 
...
\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }write{\tt\mc \ }{\tt "}{\tt -}{\tt -}{\tt -}{\tt\#}{\tt "},{\tt\mc \ }counter,{\tt\mc \ }{\tt "}{\tt -}{\tt -}{\tt -}{\tt "};

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }terpri();

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\textbf{for}{\tt\mc \ }i{\tt\mc \ }:={\tt\mc \ }0:2{\tt\mc \ }\textbf{do}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt <}{\tt <}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }write{\tt\mc \ }{\tt "}[{\tt "},{\tt\mc \ }i,{\tt\mc \ }{\tt "}]{\tt\mc \ }{\tt "};

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\textbf{for}{\tt\mc \ }j{\tt\mc \ }:={\tt\mc \ }0:array{\tt\_}size{\tt -}1{\tt\mc \ }\textbf{do}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\textbf{if}{\tt\mc \ }disc(i,{\tt\mc \ }j){\tt\mc \ }\textbf{neq}{\tt\mc \ }0{\tt\mc \ }\textbf{then}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }write{\tt\mc \ }disc(i,{\tt\mc \ }j),{\tt\mc \ }{\tt "}{\tt\mc \ }{\tt "}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\textbf{else}

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }j{\tt\mc \ }:={\tt\mc \ }array{\tt\_}size;{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ break 相当 \hfill
\tt\mc 

\noindent
\mbox{}{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }terpri()
...
\noindent
\mbox{}array{\tt\mc \ }ptr(2);{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ disc 移動用ポインタ（インデックス）\hfill
\tt\mc 
...
\noindent
\mbox{}\textbf{procedure}{\tt\mc \ }move{\tt\_}one{\tt\_}disc(i,{\tt\mc \ }j);{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ 1枚の disc を pole $i$ から\hfill
\tt\mc 
...
\noindent
\mbox{}\textbf{procedure}{\tt\mc \ }move{\tt\_}discs(n,{\tt\mc \ }i,{\tt\mc \ }j,{\tt\mc \ }k);{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ \underline{\textsf{上から $n$ 枚目までの disc}}を、\hfill
\tt\mc 
...
\noindent
\mbox{}ptr(0){\tt\mc \ }:={\tt\mc \ }array{\tt\_}size;
...
\noindent
\mbox{}move{\tt\_}discs(array{\tt\_}size,{\tt\mc \ }0,{\tt\mc \ }1,{\tt\mc \ }2);{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }{\tt\mc \ }\rm\mc {\tt\%} \ {\tt array\_size} 枚の disc をpole 0 から pole 1 に pole 2\hfill
\tt\mc 
