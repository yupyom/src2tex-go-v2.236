...
val disc = Array(3) { IntArray(ARRAY) } /* {\ disc に関するデータの置き場所\hfill} */

fun initArray() {                       /* {\ disc に関するデータの初期化\hfill} */
...
val ptr = intArrayOf(0, 0, 0)           /* {\ disc 移動用ポインタ（インデックス）\hfill} */

fun moveOneDisc(i: Int, j: Int) {       /* {\ 1枚の disc を pole $i$ からpole $j$ に移動する \hfill} */
    ptr[i]--
